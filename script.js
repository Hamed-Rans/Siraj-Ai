...
const APP_CONFIG = {
    ...
    colorNames: { navy: 'نیلگون', crimson: 'ارغوان', gold: 'زرین', purple: 'بنفشه', emerald: 'زمرد', indigo: 'نیلی' },
    colorIcons: {
...
const PATTERN_TEMPLATES = {
    eightStar: (c1, c2) => `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 240 240'><g fill='none' stroke='${c1}' stroke-width='1.2' stroke-linecap='round' stroke-linejoin='round'><path d='M120 40 L150 70 L200 70 L200 120 L230 150 L200 180 L200 230 L150 230 L120 200 L90 230 L40 230 L40 180 L10 150 L40 120 L40 70 L90 70 Z'/><circle cx='120' cy='135' r='30'/></g><circle cx='120' cy='135' r='5' fill='${c2}'/></svg>`,
    girih: (c1, c2) => `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 240 240'><g fill='none' stroke='${c1}' stroke-width='1.2' stroke-linecap='round' stroke-linejoin='round'><path d='M120 40 L160 80 L160 160 L120 200 L80 160 L80 80 Z'/><path d='M120 80 L140 100 L140 140 L120 160 L100 140 L100 100 Z'/><line x1='120' y1='40' x2='120' y2='80'/><line x1='120' y1='160' x2='120' y2='200'/></g><circle cx='120' cy='120' r='4' fill='${c2}'/></svg>`,
    arch: (c1, c2) => `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 240 240'><g fill='none' stroke='${c1}' stroke-width='1.2' stroke-linecap='round'><path d='M60 200 L60 100 Q60 40 120 40 Q180 40 180 100 L180 200'/><path d='M90 200 L90 110 Q90 70 120 70 Q150 70 150 110 L150 200'/></g><circle cx='120' cy='90' r='3' fill='${c2}'/></svg>`,
    hexGrid: (c1, c2) => `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 240 240'><g fill='none' stroke='${c1}' stroke-width='1.2'><path d='M120 40 L160 60 L160 100 L120 120 L80 100 L80 60 Z'/><path d='M120 120 L160 140 L160 180 L120 200 L80 180 L80 140 Z'/></g><circle cx='120' cy='120' r='3' fill='${c2}'/></svg>`,
    dots: (c1, c2) => `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 240 240'><g fill='${c1}' opacity='.7'><circle cx='60' cy='60' r='3'/><circle cx='120' cy='60' r='3'/><circle cx='180' cy='60' r='3'/><circle cx='90' cy='120' r='3'/><circle cx='150' cy='120' r='3'/><circle cx='60' cy='180' r='3'/><circle cx='120' cy='180' r='3'/><circle cx='180' cy='180' r='3'/></g><circle cx='120' cy='120' r='4' fill='${c2}'/></svg>`,
    waves: (c1, c2) => `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 240 240'><g fill='none' stroke='${c1}' stroke-width='1.2' stroke-linecap='round'><path d='M20 80 Q60 50 120 80 T220 80'/><path d='M20 120 Q60 90 120 120 T220 120'/><path d='M20 160 Q60 130 120 160 T220 160'/></g><circle cx='200' cy='60' r='3' fill='${c2}'/></svg>`,
    leaf: (c1, c2) => `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 240 240'><g fill='none' stroke='${c1}' stroke-width='1.2' stroke-linecap='round'><path d='M120 40 Q120 100 120 200'/><path d='M120 70 Q90 80 75 110 Q60 140 90 160 Q120 175 120 160'/><path d='M120 70 Q150 80 165 110 Q180 140 150 160 Q120 175 120 160'/></g><circle cx='120' cy='50' r='3' fill='${c2}'/></svg>`,
    circles: (c1, c2) => `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 240 240'><g fill='none' stroke='${c1}' stroke-width='1.2'><circle cx='120' cy='120' r='70'/><circle cx='120' cy='120' r='40'/></g><circle cx='120' cy='120' r='15' fill='none' stroke='${c2}' stroke-width='1.2'/></svg>`,
    lines: (c1, c2) => `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 240 240'><g stroke='${c1}' stroke-width='1' opacity='.5'><line x1='30' y1='40' x2='210' y2='40'/><line x1='30' y1='80' x2='210' y2='80'/><line x1='30' y1='120' x2='210' y2='120'/><line x1='30' y1='160' x2='210' y2='160'/><line x1='30' y1='200' x2='210' y2='200'/></g><circle cx='120' cy='120' r='3' fill='${c2}'/></svg>`
};
/* ═══════════════════════════════════════════════════════════════
   STORAGE KEYS
   ═══════════════════════════════════════════════════════════════ */
