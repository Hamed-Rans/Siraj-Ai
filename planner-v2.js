  ...
  function init(){
    ...
    function updateHeaderAvatar(){
      ...
      if (p.avatar){
        ...
        av.textContent = p.name ? p.name.substring(0,1) : '👤';
      }
    }
