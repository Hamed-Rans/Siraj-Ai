...
(function(){
  ...
  function init(){
    ...
    function dailyWordHTML(){
      ...
      var w=_currentWord;
      if(!w) return '';
      return '<div class="daily-article"><div class="da-head"><span class="da-badge">📖 '+esc(w.type)+' امروز</span></div><div class="da-text">'+esc(w.text)+'</div>'+(w.by?'<div class="da-by">— '+esc(w.by)+'</div>':'')+'</div>';
    }
